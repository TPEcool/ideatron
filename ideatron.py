...
def modify():
    ...
    def loadEditor():
        file=fs.askopenfile(title="Load lists",mode='r',initialdir=os.getcwd()+"/saves/lists",parent=modWi,defaultextension=".idea")
        if file != None:
            data = file.read()
    ...
    msg.showinfo(title="List editor",message="Welcome to the List editor! This tool allows you to edit the lists this program can generate! Please note, however, that this program does NOT save the list edits between app sessions.  All changes are applied immediately. Happy editing!")
...
fileMenu.add_command(label="Modify lists...",command=modify, image=editor_img,compound=tk.LEFT)
fileMenu.add_separator()
